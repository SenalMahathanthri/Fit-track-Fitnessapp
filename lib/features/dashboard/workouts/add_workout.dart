// lib/views/workouts/add_workout_screen.dart
...
class _AddWorkoutScreenState extends State<AddWorkoutScreen> {
  ...
  WorkoutType _selectedType = WorkoutType.FatBurn;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Add Workout', showBackButton: true),
      body: Form(
        key: _formKey,
